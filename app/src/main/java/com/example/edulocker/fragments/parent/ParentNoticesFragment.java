...
import com.example.edulocker.databinding.FragmentParentNoticesBinding;
...
public class ParentNoticesFragment extends Fragment {

    private FragmentParentNoticesBinding binding;
    private boolean showingScholarships = true;

    @Nullable @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        binding = FragmentParentNoticesBinding.inflate(inflater, container, false);
    ...
    private void loadNotices() {
        ...
        new StudentRepository().getStudentByParentUserId(uid, new StudentRepository.StudentCallback() {
            @Override public void onSuccess(Student student) {
                if (!isAdded() || binding == null) return;
                new NoticeRepository().getStudentNotices(student.getSchoolId(), student.getState(),
